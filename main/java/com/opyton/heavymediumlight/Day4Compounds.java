...
public class Day4Compounds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day4_compounds);

        bench = getIntent().getStringExtra("benchNum");
        if(bench!=null){
            backoffBench=Integer.parseInt(bench);
            double change = backoffBench / 0.94 * 0.81;
        ...
        TextView topBench = (TextView)findViewById(R.id.topSetDay4);
        TextView backoffBenchView = (TextView)findViewById(R.id.backoffSetDay4);
        ...
        Button nextBtn = (Button)findViewById(R.id.Day4NextCompound);
