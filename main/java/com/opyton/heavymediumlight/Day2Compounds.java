...
public class Day2Compounds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_day2_compounds);

        bench = getIntent().getStringExtra("benchNum");
        if(bench!=null){
            backoffBench=Integer.parseInt(bench);
            double change = backoffBench / 0.94 * 0.86;
            bench = Integer.toString((int)(5*(Math.floor(Math.abs(change/5)))));
            change = change*0.9;
        ...
        TextView topBench = (TextView)findViewById(R.id.topSetDay2);
        TextView backoffBenchView = (TextView)findViewById(R.id.backoffSetDay2);
        ...
        Button nextBtn = (Button)findViewById(R.id.Day2NextCompound);
